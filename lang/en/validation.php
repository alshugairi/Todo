...
return [
    ...
    */
    ...
    'phone_regex' => 'Phone number must contain only digits',
    ...
    'start_date' => [
        'after' => 'The start date must be a date after the current time.',
    ],
    'end_date' => [
        'after' => 'The end date must be a date after the start date.',
    ],
];
